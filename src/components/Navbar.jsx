...
const Navbar = () => {
  ...
  const menuLinks = [
    ...
    { name: "About Us", id: "page3", num: "03", sub: "Who we are" },
    { name: "Events", id: "page-events", num: "04", sub: "What we've done" },
    { name: "Team", id: "page2", num: "05", sub: "Meet the people" },
      ...
      >
        ...
        <div className="nav-menu-content-clean">
          <div className="nav-menu-left-col">
            <div className="nav-menu-logo-mark-clean">
              <div className="nm-logo-grid">
                <div className="nm-sq red"></div>
                <div className="nm-sq green"></div>
                <div className="nm-sq blue"></div>
                <div className="nm-sq yellow"></div>
              </div>
            </div>
